            ...
            <div className="w-2/4 m-5 flex flex-col items-center justify-center max-md:w-full">
              ...
              >
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full text-black border-gray-300 border-2 mb-3 focus:outline-none p-2 rounded-lg"
                  required
                />
                ...
                <input
                  ...
                  id="email"
                  ref={email}
                  className="w-full border-gray-300 text-black border-2 mb-3 focus:outline-none p-2 rounded-lg"
                  name="email"
                  required
                />
                ...
                <textarea
                  ...
                  ref={message}
                  name="message"
                  className="w-full border-gray-300 text-black border-2 mb-3 focus:outline-none p-2 rounded-lg h-28"
                  required
                ></textarea>

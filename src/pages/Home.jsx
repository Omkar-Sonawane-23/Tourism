    ...
    return (
        <section className='mt-[5px]'>
            ...
            <div className='absolute w-full bottom-[5rem]'>
                <div className='flex flex-col justify-center items-center mb-[13rem]'>
                ...
                <div className='flex justify-center items-center gap-[15rem]'>
                    <button className='text-[25px] w-[10rem] h-[2.9rem] rounded-xl bg-[black] hover:bg-yellow-400 text-[white] hover:text-[black] duration-[0.4s]' type="button">Explore</button>
                    <Link to='/home'><button className='text-[25px] w-[10rem] h-[2.9rem] rounded-xl bg-[black] hover:bg-yellow-400 text-[white] hover:text-[black] duration-[0.4s]' type="button">Places</button></Link>
                </div>
            </div>
        </section>
    )

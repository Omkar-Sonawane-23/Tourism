...
//                   type="email" onChange={(event) =>{setRegisterEmail(event.target.value);}}
//                 />
//               </div>
//               <div className="mt-4">
...
//                   onClick={togglePasswordVisibility} onChange={(event) =>{setRegisterPassword(event.target.value);}}
//                 />
//                 <i
...
//                 <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl text-black text-lg sir" onClick={registerMethod}>
//                   Sign Up
//                 </button>

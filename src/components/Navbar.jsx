...
function Navbar() {
  return (
    <section className='flex justify-evenly items-evenly shadow-xl sticky top-0 w-full bg-white z-10 '>
      <style>
  @import url('https://fonts.googleapis.com/css2?family=Agbalumo&family=Montserrat:wght@500&display=swap');
        ...
        <div className='flex my-auto'>
            <Link to='/'><li className='list-none text-xl hover:text-gray-500 m-[10px]'>Home</li></Link>
            <li className='list-none text-xl hover:text-gray-500 m-[10px]'><a href="">Places</a></li>
            <Link to='/about'><li className='list-none text-xl hover:text-gray-500 m-[10px]'>About Us</li></Link>
        </div>
    </section>
  )
}

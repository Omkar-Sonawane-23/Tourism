                            ...
                            <div className="p-4 md:w-1/3" key={index}>
                                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                    ...
                                    <div className="p-6 bg-gray-600">
                                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{event.date}</h2>
                                        <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{event.eventName}</h1>
                                        <p className="leading-relaxed mb-3 text-gray-400">{event.description}</p>
                                        <div className="flex items-center flex-wrap">
                                            <a href={event.exploreLink} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Explore
                            ...
                            <div className='flex flex-col justify-right items-right m-10'>
                                {data[0].travelTips.map((tip, index) => (
                                        <li className='text-xl text-[black] font-bold'>
                                            <a target="_blank" rel="noopener noreferrer">{tip}</a>
                                        </li>
                                ))}
